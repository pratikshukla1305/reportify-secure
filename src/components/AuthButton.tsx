...
const AuthButton = ({ className }: AuthButtonProps) => {
  ...
  return (
    <div className={cn('relative', className)}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-64 rounded-xl glass-card p-4 shadow-xl animate-scale-in">
          ...
          <div className="space-y-2">
            <button className="w-full p-3 rounded-lg border border-shield-border bg-white hover:border-shield-blue transition-all flex items-center space-x-3">
            ...
            <button className="w-full p-3 rounded-lg border border-shield-border bg-white hover:border-shield-blue transition-all flex items-center space-x-3">
              ...
              <span className="text-sm">Continue with MetaMask</span>
            </button>
          </div>
        </div>
      )}
